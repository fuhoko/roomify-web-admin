          ...
          >
            ...
            <b-col cols="9" style="position: relative">
              ...
              <b-button
                ...
                size="sm"
                class="ml-10"
                @click="$router.push(`/properties/${item.id}/detail`)"
              >
                View detail
              </b-button>
            </b-col>
...
export default {
  ...
  async fetch({ store, error, query }) {
    try {
      ...
      await store.dispatch('property/fetchList')
    } catch {
        ...
        await this.SET_SEARCH_FILTER(
          this.searchText != ''
            ? JSON.stringify({
                $or: [
                  {
                    title: { $contL: this.searchText }
                  },
                  {
                    address: { $contL: this.searchText }
                  },
                  {
